 ...
 * @param pathOrPathArray Property path as dot separated string, or array of paths. Example: 'a.b.c' or ['a.b.c', 'a.b.d']
 ...
 * // returns { a: { b: { c: 1, d: 2 } } }
 */
export const pickKeys = <T extends object>(obj: T, pathOrPathArray: TypeNestedKeyOf<T>[] | TypeNestedKeyOf<T>) => {
	const accumulator = {};

	(Array.isArray(pathOrPathArray) ? pathOrPathArray : [String(pathOrPathArray)]).forEach((propPath: string) => {
